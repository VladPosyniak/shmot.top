...
class ServerRequestTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function dataGetUriFromGlobals()
    {
        $server = [
            ...
            'SERVER_NAME' => 'www.blakesimpson.co.ua',
            ...
            'HTTP_HOST' => 'www.blakesimpson.co.ua',
            ...
            'SERVER_ADMIN' => 'webmaster@blakesimpson.co.ua',
            'SERVER_PORT' => '80',
        ...
        return [
            'Normal request' => [
                'http://www.blakesimpson.co.ua/blog/article.php?id=10&user=foo',
                $server,
            ],
            'Secure request' => [
                'https://www.blakesimpson.co.ua/blog/article.php?id=10&user=foo',
            ...
            'No query String' => [
                'http://www.blakesimpson.co.ua/blog/article.php',
                array_merge($server, ['REQUEST_URI' => '/blog/article.php', 'QUERY_STRING' => '']),
            ],
            'Different port' => [
                'http://www.blakesimpson.co.ua:8324/blog/article.php?id=10&user=foo',
    ...
    public function testFromGlobals()
    {
        ...
        $this->assertEquals(['Host' => ['www.blakesimpson.co.ua']], $server->getHeaders());
        ...
        $this->assertEquals(
            new Uri('http://www.blakesimpson.co.ua/blog/article.php?id=10&user=foo'),
            $server->getUri()
        );
