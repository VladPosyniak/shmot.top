                    ...
                    @if($errors->has())
                        <div class="panel panel-danger">
                            <div class="panel-heading">
                                <h4>Данные категории не прошли валидацию!</h4>
                            </div>
                ...
                <div class="col-md-9">
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            {!! Form::open(array('action' => array('ContentController@updateCat',$cat->id), 'method'=> 'PATCH', 'files' => true, 'class'=>'form-horizontal')) !!}
                                        ...
                                        <div class="col-sm-9">
                                            <select name="class" class="form-control">
                                                @foreach($classes as $class)
                                                    <option value="{{$class->id}}" @if($class->id === $cat->class_id) selected @endif>{{$class->description->name}}</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="form-group @if ($errors->has('urlhash')) has-error @endif">
                                        ...
                                        <div class="col-sm-9">
                                            <div class="input-group">
                                                ...
                                                {!! Form::text('urlhash', $cat->urlhash, array('class'=>'form-control')) !!}
                                        ...
                                        @if($cat->cover)
                                            <div class="col-sm-5">
                                                <img style=" max-height: 50px; "
                                                     src="{!! asset('files/cats/img/'.$cat->cover) !!}" alt="4"
