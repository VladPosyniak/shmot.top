    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">Слайдеры и баннеры</li>
            </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="row">
                                        ...
                                        <table class="table table-condensed" style="margin-bottom: 0px;">
                                            ...
                                            <td style="   vertical-align: inherit;">
                                                @foreach($slider->data as $item)
                                                    <img style="max-height: 50px;  max-width: 50px; display: inline-block"
                                                         src="{{ asset('files/sliders/'.$item['image']) }}">
                                                @endforeach
                                            </td>
                                            <td style="width: 300px;    vertical-align: inherit;">{{$slider->name}}<br>
                                                <small>{{$slider->description}}</small>
                                            </td>
                                            <td>

                                            </td>
                                            <td style="vertical-align: inherit;"><span
                                                        class="badge bg-default">{{$slider->type}}</span>
                                            </td>
                                            <td style="vertical-align: inherit;"><span
                                                        class="badge bg-default">{{$slider->identificator}}</span>
                                            </td>
                                            <td style="vertical-align: inherit;" class="text-right">
                                                <div class="btn-group ">
                                                    <a href="{!! URL::to('admin/content/sliders/edit/'.$slider->id) !!}"
                                                       class="btn btn-sm btn-primary btn-flat"><i
                                                                class=" fa fa-pencil"></i></a>
                                                    <a href="#" data-id="{{$slider->id}}"
                                                       class="btn btn-sm btn-danger btn-flat remove_prod"><i
                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-solid">
                        ...
                        <!-- /.box-header -->
                        <div class="box-body">
                            <a href="{!! URL::to('admin/content/sliders/create') !!}"
                               class="btn btn-block btn-primary btn-flat">Создать слайдер</a>
                        </div>
                        <!-- /.box-body -->
                    </div>
                </div>
