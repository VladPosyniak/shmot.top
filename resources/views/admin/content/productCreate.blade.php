                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="main">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            {!! Form::select('filters[]', $filters, Null, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%', 'multiple'=>'multiple')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label for="inputPassword4" class="col-sm-3 control-label">Сопутствующие
                                            товары</label>
                                        <div class="col-md-9">
                                            {!! Form::select('related[]', $Prods, Null, array('class'=>'form-control input-sm select2', 'style'=>'width: 100%', 'multiple'=>'multiple')) !!}
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label" for="quantity">Количество</label>
                                        <div class="col-md-9">
                                            <input name="quantity" class="form-control input-sm" type="number">
                                        </div>
                                    </div>
                                    <div class="form-group">
