...
<div class="wrapper">
    ...
    <div class="content-wrapper">
                                    ...
                                    <li id="item-{{$product->id}}">
                                        <table class="table table-condensed" style="margin-bottom: 0px;">
                                            <tbody>
                                                ...
                                                <td style="vertical-align: inherit;"><span class="badge bg-default">{{currency($product->price,'UAH')}}</span></td>
        ...
        $.ajax({
                                            type: 'POST',
                                            url: SYS_URL+'/admin/content/product/delete/'+id,
                                            data: data,
                                            //dataType: 'html',
                                            success: function(html) {
                                                window.location = SYS_URL+'/admin/content/product/delete'
                                            }
                                        });
        }
            else {
        ...
        console.log(data);
                // POST to server using $.post or $.ajax
                                        $.ajax({
                                            type: 'POST',
                                            url: SYS_URL+'/admin/content/product/sort',
                                            data: data_res,
                                            //dataType: 'html',
                                        });
                /*$.ajax({
