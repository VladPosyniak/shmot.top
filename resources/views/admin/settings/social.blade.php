                ...
                <div class="col-md-9">
                    ...
                    <div class="box">
                        ...
                        <div class="box-body">
                            ...
                            {{--<hr>--}}
                            <em>Вконтакте</em>
                            <div class="form-group @if ($errors->has('vk_id')) has-error @endif">
                                {!! Form::label('vk_id', 'ID приложения', array('class'=>'col-sm-3 control-label')) !!}
                                <div class="col-sm-9">
                                    {!! Form::text('vk_id', Setting::get('socialite.vkontakte-client_id'), array('class'=>'form-control')) !!}
                                    @if ($errors->has('vk_id')) <p class="help-block">{{ $errors->first('vk_id') }}</p> @endif
                                </div>
                            </div>
                            <div class="form-group @if ($errors->has('vk_key')) has-error @endif">
                                {!! Form::label('vk_key', 'Приватный ключ', array('class'=>'col-sm-3 control-label')) !!}
                                <div class="col-sm-9">
                                    {!! Form::text('vk_key', Setting::get('socialite.vkontakte-client_secret'), array('class'=>'form-control')) !!}
                                    @if ($errors->has('vk_key')) <p class="help-block">{{ $errors->first('vk_key') }}</p> @endif
                                </div>
                            </div>
                            <hr>
