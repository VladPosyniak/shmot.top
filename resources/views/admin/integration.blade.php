                    ...
                    <div class="flash-message">
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                {!! Form::open(array('action' => 'Admin\IntegrationController@update', 'method'=> 'PATCH', 'class'=>'form-horizontal')) !!}
                                {{--<em>Новая Почта</em>--}}
                                ...
                                {{--<hr>--}}
                                <em>Twitter</em>
                                <div class="form-group @if ($errors->has('vkontakte')) has-error @endif">
                                    {!! Form::label('vkontakte', 'Ссылка', array('class'=>'col-sm-3 control-label')) !!}
                                    <div class="col-sm-9">
                                        {!! Form::text('vkontakte', Setting::get('integration.twitter'), array('class'=>'form-control')) !!}
                                        @if ($errors->has('vkontakte')) <p class="help-block">{{ $errors->first('vkontakte') }}</p> @endif
                                    </div>
                                </div>
                                <hr>
                                <em>Вконтакте</em>
                                <div class="form-group @if ($errors->has('twitter')) has-error @endif">
                                    ...
                                    <div class="col-sm-9">
                                        {!! Form::text('twitter', Setting::get('integration.vkontakte'), array('class'=>'form-control')) !!}
                                ...
                                <div class="form-group @if ($errors->has('facebook')) has-error @endif">
                                    {!! Form::label('facebook', 'Ссылка', array('class'=>'col-sm-3 control-label')) !!}
                                    <div class="col-sm-9">
                                        {!! Form::text('facebook', Setting::get('integration.facebook'), array('class'=>'form-control')) !!}
