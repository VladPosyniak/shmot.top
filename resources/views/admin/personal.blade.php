...
{!! Form::model($user, ['method'=>'PATCH', 'action' => 'Admin\DashboardController@updatePersonalMail', 'class'=>'form-horizontal']) !!}
...
{!! Form::close(); !!}
                        ...
                        <div class="box">
                            ...
                            <div class="box-body">
                                ...
                                {!! Form::model($user, ['method'=>'PATCH', 'action' => 'Admin\DashboardController@updatePersonal', 'class'=>'form-horizontal']) !!}
