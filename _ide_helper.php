...
namespace {
    ...
    class Artisan extends \Illuminate\Support\Facades\Artisan{
        ...
        public static function handle($input, $output = null){
            ...
            return \larashop\Console\Kernel::handle($input, $output);
        }
        ...
        public static function terminate($input, $status){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \larashop\Console\Kernel::terminate($input, $status);
        }
        ...
        public static function registerCommand($command){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \larashop\Console\Kernel::registerCommand($command);
        }
        ...
        public static function call($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \larashop\Console\Kernel::call($command, $parameters);
        }
        ...
        public static function queue($command, $parameters = array()){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \larashop\Console\Kernel::queue($command, $parameters);
        }
        ...
        public static function all(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \larashop\Console\Kernel::all();
        }
        ...
        public static function output(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            return \larashop\Console\Kernel::output();
        }
        ...
        public static function bootstrap(){
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
            \larashop\Console\Kernel::bootstrap();
        }
    ...
    class Sitemap extends \Watson\Sitemap\Facades\Sitemap{
        ...
        public static function addTag($location, $lastModified = null, $changeFrequency = null, $priority = null){
            \Watson\Sitemap\Sitemap::addTag($location, $lastModified, $changeFrequency, $priority);
        }
    ...
    class Newsletter extends \Spatie\Newsletter\NewsletterFacade{
         ...
         * @static 
         */
        public static function getMembers($listName){
            return \Spatie\Newsletter\Newsletter::getMembers($listName);
        }
        ...
        public static function getCampaigns(){
            return \Spatie\Newsletter\Newsletter::getCampaigns();
        }
        ...
        public static function deleteCampaign($campaignId){
            return \Spatie\Newsletter\Newsletter::deleteCampaign($campaignId);
        }
         ...
         * @static 
         */
        public static function getCampaignReports($id){
            return \Spatie\Newsletter\Newsletter::getCampaignReports($id);
        }
        ...
        public static function getLists(){
            return \Spatie\Newsletter\Newsletter::getLists();
        }
        ...
        public static function sendCampaign($id){
            return \Spatie\Newsletter\Newsletter::sendCampaign($id);
        }
         ...
         * @static 
         */
        public static function createCampaign($fromName, $replyTo, $subject, $title, $html = '', $listName = '', $options = array(), $contentOptions = array()){
            return \Spatie\Newsletter\Newsletter::createCampaign($fromName, $replyTo, $subject, $title, $html, $listName, $options, $contentOptions);
        }
